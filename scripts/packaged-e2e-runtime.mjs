...
export const PACKAGED_E2E_RETAINED_TITLE_PATTERN = /(?:MCP-COLD-DISCOVERY|FND-02-PACKAGED-SECURITY|FND-05-STALE-RENDERER|UX-01-DENSITY|FND-09-)/;
export const PACKAGED_E2E_SELF_CONTAINED_CASES = 27;
export const PACKAGED_E2E_RETAINED_CASES = 12;
