...
export const PACKAGED_E2E_RETAINED_TITLE_PATTERN = /(?:MCP-COLD-DISCOVERY|FND-02-PACKAGED-SECURITY|FND-05-(?:STALE|UNRESPONSIVE)-RENDERER|UX-01-(?:DENSITY|WINDOW-CHROME)|FND-09-)/;
...
export const PACKAGED_E2E_RETAINED_PROFILE_ENVS = Object.freeze([
  ...
  'AIDRAW_E2E_FND05_STALE_RENDERER_PROFILE',
  'AIDRAW_E2E_FND05_UNRESPONSIVE_RENDERER_PROFILE',
  'AIDRAW_E2E_UX01_DENSITY_PROFILE',
  'AIDRAW_E2E_UX01_WINDOW_CHROME_PROFILE',
...
const RETAINED_TITLE_MARKERS = Object.freeze([
  ...
  'FND-05-STALE-RENDERER',
  'FND-05-UNRESPONSIVE-RENDERER',
  'UX-01-DENSITY',
  'UX-01-WINDOW-CHROME',
  'FND-09-',
]);
