...
export const MAX_GENERATION_PROVIDER_METADATA_BYTES = 64 * 1024;
export const MAX_GENERATION_PROVIDER_METADATA_NODES = 4_096;
export const MAX_GENERATION_PROVIDER_METADATA_DEPTH = 32;
export const MAX_GENERATION_PROGRESS_MESSAGE_BYTES = 4 * 1024;
