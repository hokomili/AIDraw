...
const api: AIDrawDesktopAPI = {
  ...
  getMcpConnection: () => ipcRenderer.invoke(IPC.mcpConnection),
  ...
  getAgentClientSetup: (clientId) => ipcRenderer.invoke(IPC.agentClientSetup, clientId),
  ...
  readPixelSelectionClipboard: (request) => ipcRenderer.invoke(IPC.readPixelSelectionClipboard, request),
