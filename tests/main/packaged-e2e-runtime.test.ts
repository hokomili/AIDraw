...
describe('packaged Level 2 platform routing', () => {
  ...
  it('freezes the reviewed split at 27 clean-package cases plus 12 immutable retained cases', () => {
    expect(PACKAGED_E2E_SELF_CONTAINED_CASES).toBe(27);
    expect(PACKAGED_E2E_RETAINED_CASES).toBe(12);
    expect(PACKAGED_E2E_SELF_CONTAINED_CASES + PACKAGED_E2E_RETAINED_CASES).toBe(39);
  });
