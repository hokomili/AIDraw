...
describe('keyboard shortcut reference', () => {
  ...
  it('keeps current public and tracker truth aligned with the bounded remapping surface', async () => {
    ...
    expect(tracker).toContain('clean and live-synchronized through base `a45b682105729aba7f83e096409005c6a1a3e600`');
    expect(tracker).toContain('The current bounded UX-01/MAP-04 source/headless candidate changes only the selected-tile collision-manager presentation');
