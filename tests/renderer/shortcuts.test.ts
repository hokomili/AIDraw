...
describe('keyboard shortcut reference', () => {
  ...
  it('keeps current public and tracker truth aligned with the bounded remapping surface', async () => {
    ...
    expect(tracker).toContain('clean and live-synchronized through base `5bc3dc1c9cc3eccfee8b3106d4fbf82135ee2071`');
    expect(tracker).toContain('The current bounded UX-01/MAP-05 source/headless candidate changes only the adjacent tileset Wang set/color manager presentation');
